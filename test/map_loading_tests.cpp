...
TEST_CASE("map_loading tests") {
    ...
    REQUIRE(get<string>(map->layers[1].objects[0].properties[0].value) == "tutorial/armor-vendor");


    REQUIRE(map->properties.size() == 5);
    REQUIRE(map->properties[0].name == "itemExpirationHours"s);
    REQUIRE(get<int>(map->properties[0].value) == 1);
    REQUIRE(map->properties[1].name == "maxSkill"s);
    REQUIRE(get<int>(map->properties[1].value) == 3);
    ...
    REQUIRE(get<int>(map->properties[3].value) == 14);
    REQUIRE(map->properties[4].name == "respawnY"s);
    REQUIRE(get<int>(map->properties[4].value) == 14);
}