...
template<typename pool_T, typename transaction_T>
void locations_repository<pool_T, transaction_T>::insert(location &loc, unique_ptr<transaction_T> const &transaction) {
...
template<typename pool_T, typename transaction_T>
void locations_repository<pool_T, transaction_T>::update(location const &loc, unique_ptr<transaction_T> const &transaction) {
...
template<typename pool_T, typename transaction_T>
optional<location> locations_repository<pool_T, transaction_T>::get(uint64_t id, unique_ptr<transaction_T> const &transaction) {
...
template<typename pool_T, typename transaction_T>
vector<location> locations_repository<pool_T, transaction_T>::get_by_map_name(string map_name, unique_ptr<transaction_T> const &transaction) {
